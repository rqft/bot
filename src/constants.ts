...
export const UserBadges: Record<UserFlags, CustomEmojis | Emojis> = {
  ...
  [UserFlags.HYPESQUAD_ONLINE_HOUSE_1]: CustomEmojis.BADGE_HYPESQUAD_BRAVERY,
  [UserFlags.HYPESQUAD_ONLINE_HOUSE_2]: CustomEmojis.BADGE_HYPESQUAD_BRILLIANCE,
...
export const GuildFeaturesEmojis: Record<GuildFeature, CustomEmojis> = {
  ...
  [GuildFeature.INTERNAL_EMPLOYEE_ONLY]: CustomEmojis.BADGE_STAFF,
};
