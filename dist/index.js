...
exports.client.once("ready", onReady_1.onReady());
exports.client.on("error", discordjsError_1.discordjsError);
exports.client.on("message", commandHandler_1.commandHandler);
