import { DefaultMessageNotifications, ExplicitContentFilterLevel, GuildChannel, GuildChannelManager, GuildEmojiManager, GuildFeatures, GuildMember, GuildMemberManager, PremiumTier, PresenceManager, RoleManager, Snowflake, SystemChannelFlags, TextChannel, VerificationLevel, VoiceChannel, VoiceState, VoiceStateManager, WebSocketShard } from "discord.js";
interface FServer {
...
declare type Server = Partial<FServer>;
export { Server };
