...
exports.default = (0, builder_1.Command)('saturation [image] [amount?] [-scale?]', {
    args: (self) => ({
        image: self.imageUrl({ size: 512 }),
        amount: self.number(),
        scale: self.booleanOptional(),
    }),
    metadata: (0, base_command_1.img)('set saturation of image', ['10', '2 -scale', '', '']),
}, async (context, args) => {
    ...
    return await (0, util_1.respond)(context, await embed_1.Embeds.image(context, payload.unwrap(), 'saturation'));
});
